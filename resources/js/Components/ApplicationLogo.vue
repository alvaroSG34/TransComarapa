<template>
    ...
    >
        <!-- Ruedas inferiores -->
        <rect x="10" y="56" width="6" height="6" opacity="0.6" />
        <rect x="48" y="56" width="6" height="6" opacity="0.6" />
        ...
        <rect x="22" y="43" width="20" height="6" fill="currentColor" opacity="0.3" />
        
        <!-- Centros de las ruedas -->
        <circle cx="51" cy="46" r="2" fill="white" />
        <circle cx="13" cy="46" r="2" fill="white" />
    </svg>
</template>
